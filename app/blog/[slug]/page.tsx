...
const posts: Record<string, { title: string; date: string; image: string; content: string }> = {
  "buying-land-zanzibar": {
    ...
    image: "https://images.unsplash.com/photo-1582610116397-edb72c0ff479?w=1200&q=80",
  ...
  "best-travel-experiences": {
    ...
    date: "March 4, 2016",
    image: "https://images.unsplash.com/photo-1540541338537-ad197cffc7f8?w=1200&q=80",
